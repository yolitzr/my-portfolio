...
const NavBar = ({ onChangeMode, isDark }) => {
  ...
  return (
    <nav
      id="navbar"
      className="w-full fixed top-0 bg-white z-10 overflow-hidden dark:bg-slate-800"
    >
      <div className="container mx-auto p-4 md:p-6 flex justify-between items-center flex-wrap">
        ...
        <ul
          className={
            isOpen
              ? "w-full flex flex-col items-center mt-4 space-y-4"
              : "hidden lg:flex space-x-10"
          }
        >
        ...
        <FontAwesomeIcon
          ...
          className="hidden lg:block text-purple-500 cursor-pointer hover:text-purple-300"
        />
      </div>
    </nav>
  )
